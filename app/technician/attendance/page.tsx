...
export default function TechnicianAttendancePage() {
  ...
  const fetchCurrentSession = async () => {
    ...
    try {
      ...
      console.error("[Technician] Error fetching current session:", error)
    }
  }
  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      ...
      console.error("[Technician] Error fetching attendance:", error)
      toast({
        title: "Error",
  ...
  const handleCheckOut = async (notes: string): Promise<boolean> => {
    ...
    try {
      ...
      const response = await attendanceApi.checkOut(currentSession.attendanceId, {
        checkOutBy: user?.user_id || "technician",
      })
      ...
      console.error("[Technician] Check-out error:", error)
      toast({
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Tabs defaultValue="attendance" className="w-full">
              ...
              <TabsContent value="regularization" className="space-y-6 mt-6">
