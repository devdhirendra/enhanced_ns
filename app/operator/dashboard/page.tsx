...
import { apiClient, customerApi } from "@/lib/api"
    ...
    <DashboardLayout title="Operator Dashboard" description="Overview of your network operations">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <Link href="/operator/customers" className="block">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
          ...
          <Link href="/operator/customers" className="block">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100 hover:shadow-xl cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Link href="/operator/invoicing" className="block">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Link href="/operator/network-map" className="block">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-orange-100 hover:shadow-xl cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      ...
                      <TableBody>
                        {recentCustomers.map((customer) => (
                          <TableRow key={customer.customer_id}>
                            <TableCell>
                              <Link href={`/operator/customers/${customer.customer_id}`}>
                                <div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {networkStatus.map((equipment) => (
                    <Link href={`/operator/network/${equipment.id}`} key={equipment.id}>
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentActivities.map((activity) => (
                    <Link href={`/operator/activities/${activity.id}`} key={activity.id}>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {quickMarketplaceItems.map((item) => (
                    <Link href={`/operator/inventory/${item.id}`} key={item.id}>
