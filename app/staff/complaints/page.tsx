...
export default function StaffComplaintsPage() {
  ...
  return (
    <DashboardLayout title="Complaints Tracking" description="View and track all customer complaints">
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>View all customer complaints in the system</CardDescription>
          </CardHeader>
          <CardContent>
