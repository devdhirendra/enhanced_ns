        ...
        <div className="hidden lg:block relative w-[55%] overflow-hidden">
          ...
          <div className="absolute bottom-16 left-12 right-12 text-white z-10">
            <h2 className="text-4xl xl:text-5xl font-bold mb-4 leading-tight">
              Powering Global<br />Network Infrastructure
            </h2>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={loading}
                    required
                    className="h-12 pr-12 border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg transition-all text-base"
                  />
                  <Button
                    type="button"
                    variant="ghost"
